...
namespace FEAManager
{
    ...
    class DB
    {
        ...
        public List<Dictionary<string, string>> selectQuery(string strTable, int attributesLength, string strConditional, Dictionary<string, string> dictAttributes)
        {
            ...
            while (reader.Read())
            {
                ...
                for (int columnDex = 0; columnDex < attributesLength; ++columnDex)
                {
                    ...
                    {
                        tempDictionary.Add(reader.GetName(columnDex), reader.GetBoolean(columnDex).ToString());
                    }
        ...
        public List<Dictionary<string, string>> selectQuery(string strTable, int attributesLength, string strConditional, Dictionary<string, string> dictAttributes, string columns)
        {
            int affectedRows;
            string sqlSelect;
            OleDbCommand command;
            ...
            List<Dictionary<string, string>> resultSet = new List<Dictionary<string, string>>();
            Dictionary<string, string> tempDictionary;
            sqlSelect = "SELECT " + columns + " FROM " + strTable + " " + strConditional;
